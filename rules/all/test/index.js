...
suite('All rules Suite:', () => {
    ...
    test('Should correctly set override max-statements rule to exclude all test files', () => {
        ...
        assert.deepEqual(maxStatementsRule[0], testutils.eslintRuleSettings.disabled);
    });
    ...
    test('Should disable array-bracket-newline rule', () => {
        ...
        assert.deepEqual(arrayBracketNewlineRule[0], testutils.eslintRuleSettings.disabled);
    });
    ...
    test('Should disable capitalized-comments rule', () => {
        ...
        assert.deepEqual(capitalizedCommentsRule[0], testutils.eslintRuleSettings.disabled);
    });
    ...
    test('Should disable eol-last rule', () => {
        ...
        assert.deepEqual(eolLastRule[0], testutils.eslintRuleSettings.disabled);
    });
    ...
    test('Should disable linebreak-style rule', () => {
        ...
        assert.deepEqual(linebreakStyleRule[0], testutils.eslintRuleSettings.disabled);
    });
    ...
    test('Should disable multiline-comment-style rule', () => {
        ...
        assert.deepEqual(multiLineCommentStyleRule[0], testutils.eslintRuleSettings.disabled);
    });
    ...
    test('Should disable no-console rule', () => {
        ...
        assert.deepEqual(noConsoleRule[0], testutils.eslintRuleSettings.disabled);
    });
    ...
    test('Should disable magic numbers rule', () => {
        ...
        assert.deepEqual(magicNumbersRule[0], testutils.eslintRuleSettings.disabled);
    });
    ...
    test('Should disable object-curly-newline rule', () => {
        ...
        assert.deepEqual(objectCurlyNewlineRule[0], testutils.eslintRuleSettings.disabled);
    });
    ...
    test('Should disable one-var rule', () => {
        ...
        assert.deepEqual(oneVarRule[0], testutils.eslintRuleSettings.disabled);
    });
    ...
    test('Should disable padded-blocks rule', () => {
        ...
        assert.deepEqual(paddedBlocksRule[0], testutils.eslintRuleSettings.disabled);
    });
    ...
    test('Should disable prefer-destructuring rule', () => {
        ...
        assert.deepEqual(preferDestructuringRule[0], testutils.eslintRuleSettings.disabled);
    });
    ...
    test('Should disable prefer-template rule', () => {
        ...
        assert.deepEqual(preferTemplateRule[0], testutils.eslintRuleSettings.disabled);
    });
    ...
    test('Should disable require-yield rule', () => {
        ...
        assert.deepEqual(requireYieldRule[0], testutils.eslintRuleSettings.disabled);
    });
