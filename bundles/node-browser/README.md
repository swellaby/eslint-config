# eslint-config-node
Our [eslint][eslint-url] configuration bundle that provides our desired linting setup for node based projects. Geared for our specific needs, but feel free to use it if it helps for you (you can always override any rule in your eslint config file)!  
